...
public class CorreoElectronico {
    ...
    public void sendEmailExcelVentasGastos(String asunto, String cuerpo, byte[] arregloBytes,
            String nombreArchivo, List<String> correos) {

        final String from = "envioFacturaElectronica12@searmedica.com";
        final String username = "envioFacturaElectronica12@searmedica.com";
        final String password = "6@v3n6G0v";
        String host = "mail.searmedica.com";
        ...
        try {
            ...
            if (arregloBytes != null) {
                DataSource dtEmail = new ByteArrayDataSource(arregloBytes,
            ...
            message.setFrom(new InternetAddress(from));
            for (String correosElectronico : correos) {
                message.addRecipient(Message.RecipientType.TO, new InternetAddress(correosElectronico.trim()));
            }
            message.setContent(multiParte);
            ...
            t.sendMessage(message, message.getAllRecipients());
            t.close();
            System.out.println("REPORTE VENTAS Y GASTOS - Sent message successfully TO " + correos);
