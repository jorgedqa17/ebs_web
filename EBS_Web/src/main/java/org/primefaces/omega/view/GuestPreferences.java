...
public class GuestPreferences implements Serializable {
    ...
    public String getFactura(Long id) throws SQLException, ClassNotFoundException {
        Gson gson = new Gson();
        List<FacturaImpresion> lista = this.servicioFactura.obtenerObjetoFacturaConsolidado(id);
